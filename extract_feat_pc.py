...
base_path="/home/flowers/work/evaluate_model/run_saved/all_json/"
arg_model_id=1
list_name_model=["WizardLM/WizardCoder-1B-V1.0","WizardLM/WizardCoder-3B-V1.0","WizardLM/WizardCoder-Python-7B-V1.0"]#,args.base_path+"hf/models/"+"WizardCoder-Python-13B-V1.0",args.base_path+"hf/models/"+"WizardCoder-15B-V1.0"]
model_id=list_name_model[arg_model_id]
...
arg_limited_trainset="limited"
if arg_limited_trainset=="limited":
    option="limited_trainset"

if arg_limited_trainset=="full":
...
with torch.no_grad():
    ...
    for seed in list_seed:
        if seed=="1":
            path_rd_gen= option+"/maps_1_rd_gen.json"
            path_elm=option+"/maps_1_elm.json"
            path_elm_nlp=option+"/maps_1_elm_NLP.json"
            path_img_rd=option+"/maps_1_imgep_random.json"
            path_imgp_smart=option+"/maps_1_imgep_smart.json"

        if seed=="2":
            path_rd_gen= option+"/maps_2_rd_gen.json"
            path_elm=option+"/maps_2_elm.json"
            path_elm_nlp=option+"/maps_2_elm_NLP.json"
            path_img_rd=option+"/maps_2_imgep_random.json"
            path_imgp_smart=option+"/maps_2_imgep_smart.json"

        if seed=="3":
            path_rd_gen= option+"/maps_3_rd_gen.json"
            path_elm=option+"/maps_3_elm.json"
            path_elm_nlp=option+"/maps_3_elm_NLP.json"
            path_img_rd=option+"/maps_3_imgep_random.json"
            path_imgp_smart=option+"/maps_3_imgep_smart.json"
        ...
        print(list_all_seed)
    with open(base_path+option+"/"+name_model+'_feat.pkl', 'wb') as f:
